...
export const metadata: Metadata = pageMetadata({
  title: TEXTES_PANIER.de.titre,
  description: TEXTES_PANIER.de.metaDescription,
  path: CHEMIN_PANIER.de,
  lang: "de",
  noindex: true,
});
  ...
  return (
    <>
      ...
      <main id="contenu">
        <HeroInterieur>
          <FilAriane
            ...
            elements={[
              ...
              { nom: mots.fil, chemin: CHEMIN_PANIER.de },
            ]}
          />
        ...
        <Section fond="blanc">
          <Panier langue="de" tunnel={lienTunnelLangue("de")} />
        </Section>
      </main>
      <Footer lang="de" />
    </>
