 ...
 * de station. Le menu pointait « Skiorte » vers l'accueil, qui a un autre rôle.
 */
export const metadata: Metadata = metadataIndexStations("de");

export default function Page() {
  return <IndexStationsIntl lang="de" />;
}
