...
export const metadata: Metadata = pageMetadata({
  title: TEXTES_PANIER.fr.titre,
  description: TEXTES_PANIER.fr.metaDescription,
  path: CHEMIN_PANIER.fr,
  lang: "fr",
  noindex: true,
});
  ...
  return (
    <>
      ...
      <main id="contenu">
        <HeroInterieur>
          <FilAriane
            ...
            elements={[
              ...
              { nom: mots.fil, chemin: CHEMIN_PANIER.fr },
            ]}
          />
        ...
        <Section fond="blanc">
          <Panier langue="fr" tunnel={lienTunnelLangue("fr")} />
        </Section>
      </main>
      <Footer lang="fr" />
    </>
