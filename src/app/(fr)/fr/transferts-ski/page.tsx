 ...
 * de station. Le menu pointait « Stations » vers l'accueil, qui a un autre rôle.
 */
export const metadata: Metadata = metadataIndexStations("fr");

export default function Page() {
  return <IndexStationsIntl lang="fr" />;
}
