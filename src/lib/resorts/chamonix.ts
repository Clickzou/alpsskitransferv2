...
export const chamonix: Resort = {
  ...
  contenu: [
    ...
    { type: "liste", items: ["Choose your airport – Geneva, Lyon, Grenoble, or Chambéry.", "Select your vehicle – Standard, Business or Premium.", "Enter your details & book online – Secure your transfer in just a few clicks.", "Meet your driver – They will be waiting for you at the airport.", "Enjoy your ride – Relax and admire the stunning scenery on the way to Chamonix."] },
    ...
    { type: "paragraphe", texte: "All of these airports are served by our private transfers, with a vehicle category to match every group size." },
