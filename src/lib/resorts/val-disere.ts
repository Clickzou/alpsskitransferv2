...
export const valDisere: Resort = {
  ...
  metaTitre: "Val d'Isère Ski Transfers | Private & Shared Options",
  metaDescription: "Book your Val d'Isère ski transfer from Geneva, Lyon & Grenoble. Private & shared transfers with door-to-door service. Fast, reliable & stress-free!",
  ...
  contenu: [
    ...
    { type: "liste", items: ["Choose your airport – Select from Geneva, Lyon, Grenoble, or Chambéry.", "Pick your transfer type – Private or shared options available.", "Book online – Get instant confirmation.", "Meet your driver at the airport – No waiting, no hassle.", "Enjoy a comfortable ride to Val d’Isère."] },
  ...
  faq: [
    ...
    { question: "What are the transfer options available to Val d'Isère?", reponse: "Travelers to Val d’Isère can choose between private and shared transfers. Private transfers offer direct, door-to-door service, ensuring privacy and flexibility in scheduling. Shared transfers are a more economical option, where you share the vehicle with other passengers heading to the same destination. Both options are available from major airports such as Geneva, Lyon, Grenoble, and Chambéry." },
    ...
    { question: "What is the cost of a ski transfer to Val d'Isère?", reponse: "The cost of a ski transfer to Val d’Isère varies based on factors such as the type of transfer (private or shared), the airport of arrival, and the service provider. For instance, some services offer transfers starting from €32 per person. It’s recommended to compare different providers to find a service that fits your budget." },
