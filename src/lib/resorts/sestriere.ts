...
export const sestriere: Resort = {
  ...
  contenu: [
    ...
    { type: "titre3", texte: "Which Vehicle for Sestriere?" },
  ...
  faq: [
    { question: "Why Choose Our Sestriere Ski Transfers?", reponse: "Booking a private ski transfer to Sestriere ensures efficiency, comfort and a price known in advance." },
    ...
    { question: "What is the cost of a ski transfer to Sestriere?", reponse: "Prices depend on your departure airport, transfer type, and group size. We offer competitive rates for private ski transfers." },
