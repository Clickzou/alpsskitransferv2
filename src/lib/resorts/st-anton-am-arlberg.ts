...
export const stAntonAmArlberg: Resort = {
  ...
  chapo: "Looking for a seamless, comfortable, and efficient way to reach St. Anton am Arlberg? Our St. Anton am Arlberg ski transfers ensure you get from major airports directly to your ski resort with zero hassle. Whether you're arriving at Innsbruck Airport, Zurich Airport, Munich Airport, or Salzburg Airport, our private ski transfers provide a stress-free journey to the heart of the Austrian Alps.",
  ...
  contenu: [
    ...
    { type: "liste", items: ["Enter your details – Choose your airport, date, and number of passengers.", "Select your transfer type – Choose between private ski transfers.", "Confirm your booking – Receive instant confirmation and secure payment.", "Meet your driver – Your chauffeur will be waiting at the airport with a sign.", "Enjoy a smooth ride – Travel comfortably to St. Anton am Arlberg."] },
  ...
  faq: [
    ...
    { question: "Are child seats available?", reponse: "Yes, child seats are available upon request and included in all private transfers." },
