...
export const zellAmSee: Resort = {
  ...
  contenu: [
    ...
    { type: "titre3", texte: "Private Options Available" },
    { type: "liste", items: ["Private ski transfers – Exclusive, direct service for the ultimate convenience."] },
    { type: "titre3", texte: "Fixed Prices & No Hidden Fees" },
    { type: "liste", items: ["Transparent pricing with no surprises.", "Competitive rates, quoted per vehicle.", "Book online in advance to secure the best availability and value."] },
    ...
    { type: "liste", items: ["Select your airport (Salzburg, Munich, Innsbruck, or Vienna).", "Choose the vehicle category that fits your group.", "Enter your travel details and confirm pricing.", "Book your ski transfer online and receive instant confirmation.", "Meet your driver at the airport and enjoy a stress-free ride!"] },
  ...
  faq: [
    ...
    { question: "Do you offer private transfers?", reponse: "Yes! We provide private transfers in three vehicle categories, from the Premium saloon to the 8-seat Transporter." },
