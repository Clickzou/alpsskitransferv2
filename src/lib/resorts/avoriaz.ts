...
export const avoriaz: Resort = {
  ...
  contenu: [
    ...
    { type: "liste", items: ["Door-to-door service from the airport to your accommodation.", "Luggage and ski equipment transport at no extra charge.", "Private transfers, in three vehicle categories."] },
  ],
