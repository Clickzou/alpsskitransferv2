...
export const andermatt: Resort = {
  ...
  contenu: [
    ...
    { type: "titre3", texte: "Which Vehicle for Andermatt" },
    { type: "paragraphe", texte: "Choosing between private ski transfers depends on your preferences and budget:" },
    { type: "liste", items: ["Private Ski Transfers:Exclusive vehicle for you and your group.", "Direct transfer with no additional stops.", "More flexibility in pick-up and drop-off times.", "Best for families, groups, and travelers who prioritize convenience.", "May involve multiple stops at different accommodations.", "Ideal for budget-conscious travelers."] },
  ...
  faq: [
    ...
    { question: "How much does a ski transfer to Andermatt cost?", reponse: "Prices vary based on the airport, the vehicle category and the number of passengers. The price follows the vehicle category: a Premium saloon costs more than a Standard Transporter." },
