...
export const selvaValGardena: Resort = {
  ...
  contenu: [
    { type: "paragraphe", texte: "Avoid the hassle of public transport, long waiting times, and multiple stops—our private and shared ski transfers allow you to travel comfortably, efficiently, and affordably. With experienced drivers, modern vehicles, and dedicated customer service, your journey to Selva Val Gardena will be seamless and enjoyable." },
    ...
    { type: "liste", items: ["No waiting – Immediate departure upon arrival.", "Door-to-door service – From airport to accommodation without hassle.", "Private and shared options – Travel in comfort, no matter your budget."] },
  ...
  faq: [
    ...
    { question: "Are there shared transfer options available to Selva Val Gardena?", reponse: "Yes, shared transfers are available and can be a cost-effective option. However, they may involve longer travel times due to multiple stops. Private transfers offer direct routes and personalized service." },
