...
export const sauzeDoulx: Resort = {
  ...
  metaDescription: "Fast & reliable Sauze d'Oulx ski transfers! Book now for a private or shared transfer to the slopes. Secure your ride today & travel stress-free!",
  ...
  contenu: [
    { type: "paragraphe", texte: "With our private and shared ski transfers, you can travel on your schedule, avoiding the hassle of public transport or long waits at the airport. Our professional drivers provide safe, direct, and affordable transfers from major airports, allowing you to sit back and enjoy the breathtaking alpine scenery. Whether you're traveling alone, with family, or in a group, we offer customized options to fit your needs." },
  ...
  faq: [
    { question: "How to Get to Sauze d'Oulx?", reponse: "We provide convenient ski transfers from major airports to Sauze d'Oulx: ✅ Turin Airport (TRN) to Sauze d'Oulx – 1h 15m✅ Milan Malpensa Airport (MXP) to Sauze d'Oulx – 2h 30m✅ Milan Linate Airport (LIN) to Sauze d'Oulx – 2h 15m✅ Geneva Airport (GVA) to Sauze d'Oulx – 3h 45m Whether you’re looking for a direct private transfer or a budget-friendly shared transfer, we ensure a comfortable, hassle-free experience." },
    { question: "What are the available options for ski transfers to Sauze d'Oulx?", reponse: "Travelers to Sauze d’Oulx can choose between private and shared ski transfers. Private transfers offer direct, door-to-door service tailored to your schedule, while shared transfers are a cost-effective option where you share the vehicle with other passengers heading to the same destination." },
    ...
    { question: "What is the cost of a ski transfer to Sauze d'Oulx?", reponse: "The cost of a ski transfer varies depending on the type of service (private or shared), the number of passengers, and the chosen airport. For example, private transfers from Turin to Sauze d’Oulx start from approximately £34.46 per person." },
