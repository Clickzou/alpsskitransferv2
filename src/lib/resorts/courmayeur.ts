...
export const courmayeur: Resort = {
  ...
  chapo: "Looking for a Courmayeur ski transfer that ensures a stress-free, direct, and comfortable journey to one of Italy’s most prestigious ski destinations? Our private and shared ski transfers provide door-to-door service from major airports, including Geneva Airport, Milan Airport, Turin Airport, Lyon Airport, and Chambéry Airport, directly to Courmayeur ski resort. Whether you’re arriving for a quick ski weekend or an extended stay, we ensure a safe, reliable, and seamless transfer experience.",
  ...
  contenu: [
    ...
    { type: "liste", items: ["Door-to-door transfers from airports and train stations directly to your accommodation.", "Flexible options – Choose between private and shared transfers to match your budget.", "Experienced drivers – Trained for winter conditions, ensuring a safe and smooth journey.", "Flight tracking & real-time adjustments – No stress if your flight is delayed.", "Plenty of space for ski equipment and luggage at no extra cost."] },
    ...
    { type: "liste", items: ["Enter your travel details – Select your airport, date, and drop-off location.", "Choose between a private or shared transfer based on your preference.", "Confirm your booking and receive an instant confirmation.", "Meet your driver at the airport and enjoy a hassle-free ride."] },
    ...
    { type: "titre3", texte: "Is there a difference between private and shared transfers?" },
    { type: "liste", items: ["Private transfers offer direct, exclusive service with no stops.", "Shared transfers are more budget-friendly but may include multiple stops."] },
    { type: "paragraphe", texte: "Both options provide a safe and comfortable ride to Courmayeur." },
  ],

  faq: [
    { question: "Why Choose Our Courmayeur Ski Transfers?", reponse: "We offer both private and shared Courchevel ski transfers, allowing you to choose the option that best fits your needs: Choosing a Courmayeur ski transfer means comfort, reliability, and efficiency. We offer:" },
    ...
    { question: "Courmayeur Ski Resort Transfer Options ?", reponse: "We offer both private and shared transfer options, catering to different travel needs:" },
