...
export const lesArcs: Resort = {
  ...
  chapo: "Looking for Les Arcs Ski Transfers that are fast, reliable, and stress-free? Whether you're flying into Geneva Airport, Lyon Airport, Grenoble Airport, or Chambéry Airport, our private ski transfers provide a seamless, door-to-door journey to one of the most popular ski resorts in the French Alps.",
  ...
  contenu: [
    ...
    { type: "liste", items: ["Competitive prices for all budgets.", "Easy online booking with instant confirmation.", "Private transfers, in three vehicle categories."] },
  ...
  faq: [
    ...
    { question: "What are private airport ski transfers?", reponse: "Private airport ski transfers are transportation services that offer direct, exclusive travel from the airport to your chosen ski resort. A private transfer provides a personalised experience, with comfort and convenience. These services are ideal for travelers seeking a seamless journey to their ski destination." },
    { question: "What are the costs associated with ski transfers?", reponse: "The cost of ski transfers varies based on factors such as distance, vehicle category, and additional amenities. Prices are competitive, with options to fit different budgets. It’s advisable to compare prices to find the best value for your needs." },
    ...
    { question: "How can I compare ski transfer services?", reponse: "To compare transfer companies, consider factors such as the vehicle categories on offer, pricing, vehicle options, and customer reviews. Utilizing a transfer finder tool can assist in evaluating different options to make an informed decision." },
