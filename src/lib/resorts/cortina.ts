...
export const cortina: Resort = {
  ...
  contenu: [
    ...
    { type: "liste", items: ["Fast & Direct Service – No unnecessary stops, direct door-to-door transfers.", "Experienced Drivers – Navigate mountain roads safely and efficiently.", "Comfortable Vehicles – Luxury saloons, spacious minivans and 8-seat Transporters.", "Flexible Booking – Easily modify your transfer to match your flight schedule.", "Competitive Prices – Affordable ski transfers with no hidden fees."] },
    ...
    { type: "liste", items: ["Book online by selecting your airport and Cortina ski transfer option.", "Compare the price of each vehicle category.", "Secure your transfer with instant confirmation.", "Meet your driver at the airport.", "Enjoy a smooth, direct ride to Cortina d’Ampezzo."] },
    { type: "paragraphe", texte: "Book your ski transfer today and ensure a hassle-free start to your winter holiday!" },
    { type: "liste", items: ["Airport of arrival (Venice, Treviso, Innsbruck, Verona, Milan).", "Standard, Business or Premium.", "Time of booking (early booking ensures the best rates)."] },
