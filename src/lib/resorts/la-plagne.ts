...
export const laPlagne: Resort = {
  ...
  metaDescription: "Book your La Plagne ski transfer now! Private & shared airport transfers from Geneva, Lyon, Grenoble & Chambéry for a fast, stress-free journey.",
  h1: "La Plagne Ski Transfers – Fast, Reliable & Comfortable",
  chapo: "Looking for La Plagne Ski Transfers that guarantee a seamless, comfortable, and stress-free journey to one of the most popular ski resorts in the French Alps? Whether you need a private transfer for a more exclusive experience or a shared transfer for a budget-friendly option, we provide fast, direct, and reliable transfers from Geneva Airport, Lyon Airport, Grenoble Airport, and Chambéry Airport straight to La Plagne.",
  ...
  contenu: [
    ...
    { type: "liste", items: ["Door-to-door service – No need for additional transport.", "Professional, English-speaking drivers experienced in winter conditions.", "Flexible booking options – Private transfers for comfort, shared transfers for budget-friendly travel.", "Flight monitoring – Adjustments made for delays at no extra cost.", "Extra luggage space – Ski equipment transport included."] },
    ...
    { type: "liste", items: ["Choose your transfer type – Private or shared.", "Select your airport – Geneva, Lyon, Grenoble, or Chambéry.", "Confirm your travel details and secure your booking.", "Meet your driver at the airport for a smooth, direct transfer to your accommodation."] },
    { type: "paragraphe", texte: "Enjoy a stress-free start to your ski holiday with our trusted La Plagne ski transfer services." },
    { type: "liste", items: ["Private Transfers: Offer a direct, door-to-door service exclusively for your group, ensuring comfort and flexibility.", "Shared Transfers: A cost-effective option where you share the vehicle with other passengers heading to the same destination.", "Public Transport: Involves trains or buses, which may require multiple changes and longer travel times."] },
    ...
    { type: "liste", items: ["Shared Transfers: Prices start from around €49.50 per person.", "Private Transfers: For a group of 8 adults, a return private transfer can cost approximately £471.70, equating to about £58.96 per person."] },
