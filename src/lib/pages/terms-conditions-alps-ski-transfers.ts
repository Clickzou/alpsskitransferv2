...
export const termsConditionsAlpsSkiTransfers: PageFonctionnelle = {
  ...
  contenu: [
    ...
    { type: "liste", items: ["You can ask for a new pick-up time, up to 24 hours before each pick-up, from the “Manage my booking” link in your confirmation email. The new time applies once we have confirmed it by email; your flight number can be corrected there directly.", "Within 24 hours, or for any other change (vehicle, route, number of passengers), contact us: changes are subject to availability and additional charges if applicable."] },
    { type: "titre2", texte: "3. Cancellation & Refund Policy" },
    { type: "titre3", texte: "3.1 Cancellation by the Customer" },
    { type: "liste", items: ["More than 24 hours before the scheduled transfer: full refund, minus any applicable transaction fees.", "Within 24 hours of the scheduled transfer: no refund."] },
    ...
    { type: "liste", items: ["Any complaints regarding the service must be submitted within 7 days of travel.", "Complaints should be sent via email to contact@alpsskitransfers.com, including booking details and issue description."] },
