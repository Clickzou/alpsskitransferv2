...
- Chaque ligne : nom, téléphone, référence, puis pour chaque trajet (aller, retour) l'heure, le trajet, l'adresse en station, les passagers et le véhicule.
...
- « Où l'on se situe » : tableau nous / alps2alps / Alpy par trajet, filtrable par jour, véhicule et nombre de passagers.
